...
kubectl set image deployments/client-deployment client=ypritas/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=ypritas/multi-worker:$SHA